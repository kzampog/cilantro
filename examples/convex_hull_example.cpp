...
int main(int argc, char ** argv) {
    ...
    VtoH<Eigen::Vector3f,Eigen::Vector3f,Eigen::Vector4f>(points, hull_points, halfspaces, faces, hull_pt_indices, area, volume);
    ...
    HtoV<Eigen::Vector4f,Eigen::Vector3f,Eigen::Vector4f>(halfspaces, hull_points2,halfspaces2,faces2,hull_pt_indices2, area2, volume2);
