...
int main(int argc, char** argv) {
  ...
  ne.covarianceMethod().setChiSquareThreshold(6.25).setNumberOfTrials(2).setNumberOfRefinements(
      1);  // 90% confidence ellipsoid
  ...
  viz.addObject<cilantro::PointCloudRenderable>(
      "cloud_i", invalid_cloud, cilantro::RenderingProperties().setPointColor(255, 0, 0));
