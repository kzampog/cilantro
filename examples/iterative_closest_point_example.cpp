...
int main(int argc, char ** argv) {
    ...
    R_ref = Eigen::AngleAxisf(-0.3 ,Eigen::Vector3f::UnitZ()) *
            Eigen::AngleAxisf(0.10, Eigen::Vector3f::UnitY()) *
            Eigen::AngleAxisf(-0.2, Eigen::Vector3f::UnitX());
    Eigen::Vector3f t_ref(-0.05, 0.05, 0.13);
...
//    IterativeClosestPoint icp(dst, src, IterativeClosestPoint::Metric::POINT_TO_POINT);
    ...
    icp.setMaxCorrespondenceDistance(0.15f).setConvergenceTolerance(0.001).setMaxNumberOfIterations(50).setMaxNumberOfPointToPlaneIterations(1);
