...
public:
  ...
  template <ptrdiff_t Dim = EigenDim, class = typename std::enable_if<Dim != Eigen::Dynamic>::type>
  DataMatrixMap(ScalarT* data, size_t num_points = 0) : Base(data, EigenDim, num_points) {}

  DataMatrixMap(ScalarT* data, size_t dim, size_t num_points) : Base(data, dim, num_points) {}
...
template <typename ScalarT, ptrdiff_t EigenDim>
using HomogeneousVectorSetMatrixMap =
    typename std::conditional<EigenDim == Eigen::Dynamic, DataMatrixMap<ScalarT, EigenDim>,
                              DataMatrixMap<ScalarT, EigenDim + 1>>::type;
...
public:
  ...
  inline const Base& base() { return *static_cast<Base*>(this); }
};
...
template <typename ScalarT, ptrdiff_t EigenDim>
using ConstHomogeneousVectorSetMatrixMap =
    typename std::conditional<EigenDim == Eigen::Dynamic, ConstDataMatrixMap<ScalarT, EigenDim>,
                              ConstDataMatrixMap<ScalarT, EigenDim + 1>>::type;
...
typedef ConstHomogeneousVectorSetMatrixMap<float, Eigen::Dynamic>
    ConstHomogeneousVectorSetMatrixMapXf;
typedef ConstHomogeneousVectorSetMatrixMap<double, Eigen::Dynamic>
    ConstHomogeneousVectorSetMatrixMapXd;
...
template <typename ScalarT, ptrdiff_t EigenDim>
using HomogeneousVector =
    typename std::conditional<EigenDim == Eigen::Dynamic, Eigen::Matrix<ScalarT, EigenDim, 1>,
                              Eigen::Matrix<ScalarT, EigenDim + 1, 1>>::type;
...
template <typename ScalarT, ptrdiff_t EigenDim>
using HomogeneousVectorSet =
    typename std::conditional<EigenDim == Eigen::Dynamic,
                              Eigen::Matrix<ScalarT, EigenDim, Eigen::Dynamic>,
                              Eigen::Matrix<ScalarT, EigenDim + 1, Eigen::Dynamic>>::type;
...
template <typename ScalarT, ptrdiff_t EigenDim>
struct DataMatrixView<ScalarT, EigenDim, DataMatrixViewMode::Matrix> {
  typedef VectorSet<ScalarT, EigenDim> Container;
};

template <typename ScalarT, ptrdiff_t EigenDim>
struct DataMatrixView<ScalarT, EigenDim, DataMatrixViewMode::MatrixRef> {
  typedef VectorSet<ScalarT, EigenDim>& Container;
};

template <typename ScalarT, ptrdiff_t EigenDim>
struct DataMatrixView<ScalarT, EigenDim, DataMatrixViewMode::ConstMatrixRef> {
  typedef const VectorSet<ScalarT, EigenDim>& Container;
};

template <typename ScalarT, ptrdiff_t EigenDim>
struct DataMatrixView<ScalarT, EigenDim, DataMatrixViewMode::MatrixMap> {
  typedef DataMatrixMap<ScalarT, EigenDim> Container;
};

template <typename ScalarT, ptrdiff_t EigenDim>
struct DataMatrixView<ScalarT, EigenDim, DataMatrixViewMode::ConstMatrixMap> {
  typedef ConstDataMatrixMap<ScalarT, EigenDim> Container;
};
