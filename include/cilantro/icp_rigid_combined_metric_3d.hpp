...
namespace cilantro {
    ...
    public:
        ...
        CombinedMetricRigidICP3(const ConstVectorSetMatrixMap<ScalarT,3> &dst_p,
                ...
                : IterativeClosestPointBase<CombinedMetricRigidICP3<ScalarT,CorrespondenceSearchEngineT>,RigidTransformation<ScalarT,3>,CorrespondenceSearchEngineT,VectorSet<ScalarT,1>>(corr_engine),
                  ...
                  max_estimation_iterations_(1), point_to_point_weight_((ScalarT)0.1), point_to_plane_weight_((ScalarT)1.0)
        {
    ...
    protected:
        ...
        bool updateCorrespondences() {
            ...
            return this->correspondences_.size() >= 3;
        }
...
#pragma omp parallel for
            ...
            estimateRigidTransformCombinedMetric3D<ScalarT,typename CorrespondenceSearchEngineT::CorrespondenceScalar>(dst_points_, dst_normals_, src_points_trans_, this->correspondences_, point_to_point_weight_, point_to_plane_weight_, tform_iter, max_estimation_iterations_, this->convergence_tol_);
