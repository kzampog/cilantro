...
namespace cilantro {
    ...
    private:
        ...
        void updateEstimate() {
            ...
            this->last_delta_norm_ = std::sqrt((tform_iter.linear() - Eigen::Matrix<typename TransformT::Scalar,TransformT::Dim,TransformT::Dim>::Identity()).squaredNorm() + tform_iter.translation().squaredNorm());
        }
