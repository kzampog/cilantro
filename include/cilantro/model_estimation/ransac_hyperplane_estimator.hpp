...
class HyperplaneRANSACEstimator
    : public RandomSampleConsensusBase<HyperplaneRANSACEstimator<ScalarT, EigenDim>,
                                       Eigen::Hyperplane<ScalarT, EigenDim>, ScalarT, IndexT> {
  typedef RandomSampleConsensusBase<HyperplaneRANSACEstimator<ScalarT, EigenDim>,
                                    Eigen::Hyperplane<ScalarT, EigenDim>, ScalarT, IndexT>
      Base;
...
public:
  ...
  inline HyperplaneRANSACEstimator& estimateModel(
  ...
  inline HyperplaneRANSACEstimator& estimateModel(
      const typename Base::IndexVector& sample_ind,
      Eigen::Hyperplane<ScalarT, EigenDim>& model_params) {
  ...
  inline HyperplaneRANSACEstimator& computeResiduals(
      const Eigen::Hyperplane<ScalarT, EigenDim>& model_params,
  ...
  inline typename Base::ResidualVector computeResiduals(
      const Eigen::Hyperplane<ScalarT, EigenDim>& model_params) {
    typename Base::ResidualVector residuals;
