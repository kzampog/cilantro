...
#include <cilantro/3rd_party/libqhull_r/user_r.h>      /* user definable constants (e.g., realT). */

#include <cilantro/3rd_party/libqhull_r/mem_r.h>   /* Needed for qhT in libqhull_r.h */
#include <cilantro/3rd_party/libqhull_r/qset_r.h>   /* Needed for QHULL_LIB_CHECK */
...
#include <cilantro/3rd_party/libqhull_r/stat_r.h>  /* needs boolT */
